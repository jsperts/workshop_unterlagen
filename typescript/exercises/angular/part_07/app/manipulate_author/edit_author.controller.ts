...
import {EditAuthorCtrlCtor, EditAuthorCtrlInstance} from '../common/interfaces/controllers';

const EditAuthor: EditAuthorCtrlCtor = function EditAuthor(
    $scope, authorsService: AuthorsServiceInstance, $routeParams, $location
): EditAuthorCtrlInstance {
