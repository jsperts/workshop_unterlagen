...
function Rectangle(color: string, width: number, height: number, name: string) {
...
function Square(color: string, width: number, name: string) {
...
ShapesManager.prototype.render = function (): string {
  const htmlStrings: Array<string> = this.shapes.map(function (shape) {
