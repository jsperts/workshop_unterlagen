...
function Shape(color: string, name: string): Shape {
  this.color = color;
  this.name = name;
...
Shape.prototype.getStyle = function (): ShapeStyle {
  return {
...
Rectangle.prototype.getStyle = function (): RectangleStyle {
...
Square.prototype.getStyle = function (): RectangleStyle {
...
Diamond.prototype.getStyle = function (): DiamondStyle {
...
Circle.prototype.getStyle = function (): CircleStyle {
  const style = Shape.prototype.getStyle.call(this);
...
ShapesManager.prototype._filterByName = function (name: string): Array<Shape> {
